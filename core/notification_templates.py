...
BOUNCED_TEMPLATES = {
    NotificationTrigger.BOUNCED_DAY1: NotificationTemplate(
        text="""👋 {first_name}, спасибо что зарегистрировался!

Но заметили — ты ещё ничего не попробовал 🤔

<b>Давай исправим за 2 минуты:</b>

🎯 Реши 3 простых вопроса
💡 Получи персональные рекомендации
🎁 Попробуй AI-проверку БЕСПЛАТНО

<b>Интересный факт:</b>
Ученики, которые решают первые вопросы в день регистрации, в 5 раз чаще готовятся регулярно и сдают на 80+

⏰ До ЕГЭ: <b>{days_to_ege} {days_word}</b>
Каждый день на счету!

<i>Попробуй сейчас, пока мотивация есть 🔥</i>""",
        buttons=[
            {"text": "🚀 Начать сейчас (2 мин)", "callback_data": "start_onboarding"},
            {"text": "💎 Узнать про trial за 1₽", "callback_data": "subscribe_trial_7days"}
        ]
    ),

    NotificationTrigger.BOUNCED_DAY3: NotificationTemplate(
        text="""🎯 {first_name}, ты упускаешь что-то важное

Пока ты откладывал:
• 47 учеников решили первые 10 вопросов
• 23 уже попробовали AI-проверку
• 12 оформили trial за 1₽

<b>А ты все ещё на старте</b> 😔

🎁 <b>Специально для тебя:</b>
3 бесплатных AI-проверки СЕГОДНЯ
Проверь задание 24 или 25 как на реальном ЕГЭ!

⏰ До ЕГЭ: <b>{days_to_ege} {days_word}</b>

<i>Не дай другим обогнать тебя 🏃‍♂️</i>""",
        buttons=[
            {"text": "🔥 Начать подготовку", "callback_data": "start_onboarding"},
            {"text": "💎 Попробовать AI бесплатно", "callback_data": "choose_task24"},
            {"text": "🎁 Trial за 1₽", "callback_data": "subscribe_trial_7days"}
        ]
    ),

    NotificationTrigger.BOUNCED_DAY7: NotificationTemplate(
        text="""⚠️ {first_name}, это последнее сообщение

Прошла неделя с регистрации, но ты так и не начал.

Вот что ты упускаешь:
❌ 1000+ вопросов для подготовки
❌ ИИ-проверку как на реальном ЕГЭ
❌ 3 бесплатных AI-проверки каждую неделю
❌ Шанс подготовиться вовремя

⏰ До ЕГЭ осталось всего {days_to_ege} {days_word}

🚨 <b>Последний шанс попробовать бесплатно</b>
Через неделю мы перестанем писать.

<i>Попробуй сейчас или потеряешь шанс навсегда</i>""",
        buttons=[
...
CURIOUS_TEMPLATES = {
    NotificationTrigger.CURIOUS_DAY3: NotificationTemplate(
        text="""🎉 {first_name}, отлично начал! {answered_total} вопросов решено!

<b>Но есть проблема:</b>
Ты остановился на полпути к первой цели 😔

<b>Статистика успеха:</b>
• Решили 10+ вопросов → 80% остаются готовиться
• Решили 5-9 вопросов → только 20% возвращаются
• Ты сейчас здесь → {answered_total} вопросов

Тебе осталось всего <b>{questions_to_milestone} вопросов</b> до важной вехи! 🎯

🎁 У тебя есть <b>{checks_remaining} бесплатных AI-проверок</b> сегодня

⏰ До ЕГЭ: {days_to_ege} {days_word}

<i>Не дай себе стать статистикой - продолжи прямо сейчас!</i>""",
        buttons=[
            {"text": "🔥 Решить 5 вопросов (10 мин)", "callback_data": "choose_test_part"},
            {"text": "💎 Trial за 1₽ на неделю", "callback_data": "subscribe_trial_7days"}
        ]
    ),

    NotificationTrigger.CURIOUS_DAY7: NotificationTemplate(
        text="""📉 {first_name}, неделя прошла... а ты так и не вернулся

<b>Пока ты отсутствовал:</b>
• 89 учеников решили по 50+ вопросов
• 34 оформили подписку
• 12 улучшили пробники на 15+ баллов

<b>А твой прогресс?</b>
Всего {answered_total} вопросов за всё время 😔

⚠️ <b>Критично:</b>
До ЕГЭ осталось {days_to_ege} {days_word}
Каждый день промедления = минус 1-2 балла на экзамене

🎁 <b>Последнее предложение:</b>
Trial за 1₽ + 3 бесплатных AI-проверки сегодня

<i>Вернись пока не поздно 🚨</i>""",
        buttons=[
            {"text": "🔥 Вернуться к подготовке", "callback_data": "to_main_menu"},
            {"text": "💎 Trial за 1₽", "callback_data": "subscribe_trial_7days"},
            {"text": "❌ Удалить меня", "callback_data": "notifications_disable"}
        ]
    )
}
...
Но есть нюанс...
Вторая часть ЕГЭ даёт 60% баллов, а у тебя доступно только 3 проверки в неделю.
