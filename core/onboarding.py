...
Теперь ты знаешь как пользоваться ботом. Вот что доступно:

🆓 <b>Бесплатно навсегда:</b>
• 1000+ вопросов тестовой части
• 3 ИИ-проверки в день
• Отслеживание прогресса

💎 <b>С подпиской (от 249₽/мес):</b>
• Безлимитные ИИ-проверки
• Все задания 19-25
• Персональные рекомендации

👇 <b>Выбери раздел и начинай готовиться:</b>
"""
