...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if subscription_info and subscription_info.get('is_active'):
        ...
        welcome_text += f"<b>✅ У вас активная подписка до {expires}</b>\n\n"
        welcome_text += "📚 <b>Всё для подготовки в одном месте!</b>\n"
        welcome_text += "Больше не нужно таскать сборники и искать ответы в конце учебника.\n\n"
        welcome_text += "<b>💡 Совет дня:</b> Практикуйся в любой момент — едешь в автобусе или ждёшь друга?\n"
        welcome_text += "Каждая свободная минута работает на твой результат!\n\n"
        welcome_text += "Выберите модуль для продолжения:"
    else:
        # Новый пользователь или без подписки
        welcome_text = f"{greeting}, {user_name}! 👋\n\n"
        welcome_text += "<b>🎓 Подготовка к ЕГЭ по обществознанию в твоём телефоне!</b>\n\n"
        welcome_text += "<b>🆓 БЕСПЛАТНО доступна тестовая часть:</b>\n"
        welcome_text += "• 1000+ вопросов с подробными разборами\n"
        welcome_text += "• Все темы кодификатора\n"
        welcome_text += "• Режимы тренировки по блокам и номерам\n"
        welcome_text += "• Базовая статистика прогресса\n\n"
        welcome_text += "<b>💎 Почему стоит оформить подписку от 199₽/мес:</b>\n\n"
        welcome_text += "🤖 <b>ИИ-проверка за секунды</b> — специально обученная нейросеть проверяет твои развёрнутые ответы по критериям ФИПИ. "
        welcome_text += "Никаких 'правильно/неправильно' — получаешь подробный разбор, как от настоящего эксперта.\n\n"
        welcome_text += "📚 <b>Всё в одном месте</b> — от тестовой части до сложных планов. "
        welcome_text += "Больше не нужно таскать сборники и искать ответы в конце учебника.\n\n"
        welcome_text += "⚡ <b>Практика в любой момент</b> — едешь в автобусе? Решай тесты. "
        welcome_text += "Ждёшь друга? Тренируй задание 24. Каждая свободная минута работает на твой результат.\n\n"
        welcome_text += "📊 <b>Умная статистика</b> — бот запоминает твои ошибки и показывает, над чем работать. "
        welcome_text += "Больше никаких пробелов в знаниях!\n\n"
        welcome_text += "💰 <b>Честные цены</b> — пробный период всего за 1₽, потом от 199₽/мес за нужные модули. "
        welcome_text += "Платишь только за то, что используешь.\n\n"
        welcome_text += "<b>👇 Начни прямо сейчас — тестовая часть уже доступна!</b>"
