        ...
        conv_handler = ConversationHandler(
            ...
            states={
                states.CHOOSING_MODE: [
                    ...
                    CallbackQueryHandler(handlers.t24_search_topics, pattern="^t24_search_topics$"),
                    ...
                    CallbackQueryHandler(handlers.t24_reset_progress, pattern="^t24_reset_progress$"),
                    CallbackQueryHandler(handlers.show_block_stats, pattern="^t24_show_progress$"),
                    ...
                    CallbackQueryHandler(handlers.t24_cancel_reset, pattern="^t24_cancel_reset$"),
                ],
            ...
            fallbacks=[
                ...
                CallbackQueryHandler(handlers.back_to_menu, pattern="^t24_start_button$"),
            ],
            allow_reentry=True,
        )
