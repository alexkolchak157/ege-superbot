...
def build_main_menu_keyboard() -> InlineKeyboardMarkup:
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("🔍 Поиск темы", callback_data="t24_search_topics")],
        [InlineKeyboardButton("📜 Список всех тем", callback_data="show_list")],
        [InlineKeyboardButton("📊 Мой прогресс", callback_data="t24_show_progress")],
...
def build_search_keyboard() -> InlineKeyboardMarkup:
    ...
    keyboard = [
        [InlineKeyboardButton("❌ Отмена", callback_data="t24_start_button")]
    ]
    return InlineKeyboardMarkup(keyboard)
